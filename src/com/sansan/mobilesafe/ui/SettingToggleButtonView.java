...
public class SettingToggleButtonView extends RelativeLayout{
	...
	private void iniView(Context context) {
		...
		View.inflate(context, R.layout.seting_togglebutton, this);
	...
	public SettingToggleButtonView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		iniView(context);
	}

	public SettingToggleButtonView(Context context, AttributeSet attrs) {
		super(context, attrs);
		iniView(context);
		//获得自定义属性,这样可以不用初始化图片
...
//		desc_on = attrs.getAttributeValue("http://schemas.android.com/apk/res/com.sansan.mobilesafe", "desc_on");
	...
	public SettingToggleButtonView(Context context) {
		super(context);
		iniView(context);
	}
