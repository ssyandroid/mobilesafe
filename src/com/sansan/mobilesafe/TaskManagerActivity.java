...
import com.sansan.mobilesafe.utils.SystemInfoUtils;
...
public class TaskManagerActivity extends Activity {
	...
	private void setTitle() {
		...
		tv_process_count.setText("进程：" + processCount + "个");
...
//				Log.i(TAG, "创建新的view对象" + position);
	...
	public void killAll(View view) {
		...
		adapter.notifyDataSetChanged();
		if(count == 0){
			Toast.makeText(this,"请勾选需要清理的进程", 0).show();
		}else{
			Toast.makeText(
					this,
					"杀死了" + count + "个进程，释放了"
	 ...
	 * @param view
	 */
	public void rightSetting(View view) {
