...
import com.sansan.mobilesafe.bean.AppInfo;
import com.sansan.mobilesafe.engine.AppInfoProvider;
import com.sansan.mobilesafe.utils.DensityUtil;
	...
	public void onClick(View v) {
		...
		case R.id.ll_uninstall:
			if (appInfo.isUserApp()) {
				...
				Toast.makeText(this, "系统应用不可以卸载", 0).show();
